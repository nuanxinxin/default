<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\project\default\public/../application/admin\view\pawn\index.html";i:1499648212;s:63:"D:\project\default\public/../application/admin\view\header.html";i:1483770726;s:64:"D:\project\default\public/../application/admin\view\loading.html";i:1481350888;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form action="" method="get" class="layui-form">
                ...
                <div class="layui-input-inline">
                    <select name="status">
                        ...
                        <?php $_5962d1781698b=config('pawn_status'); if(is_array($_5962d1781698b) || $_5962d1781698b instanceof \think\Collection || $_5962d1781698b instanceof \think\Paginator): if( count($_5962d1781698b)==0 ) : echo "" ;else: foreach($_5962d1781698b as $key=>$item): ?>
    ...
    layui.use(['base', 'form'], function () {
        ...
        $(".del").click(function () {
            ...
            layer.confirm('确认删除?', {
                ...
                window.location.href = "<?php echo path('delPawnInfo'); ?>?id=" + id;
            });
        });
    });
</script>
