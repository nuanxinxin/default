<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\project\default\public/../application/admin\view\document\question.html";i:1499647596;s:63:"D:\project\default\public/../application/admin\view\header.html";i:1483770726;s:64:"D:\project\default\public/../application/admin\view\loading.html";i:1481350888;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use(['base', 'form'], function () {
        ...
        $(".del").click(function () {
            ...
            layer.confirm('确认删除?', {
                ...
                window.location.href = "<?php echo path('delQuestion'); ?>?id=" + id;
            });
        });
